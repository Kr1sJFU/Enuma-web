...
// 129 frames per turn at 16 fps. Turn 4 contains 04[0..59] + 05[0..68].
const chapters = [
  { start: 0, end: 8.0625, label: 'Sever the chain', action: 'CUT', key: 'E', hotspot: 'is-chain' },
  { start: 8.0625, end: 16.125, label: 'Cross the bridge', action: 'FORWARD', key: 'W', hotspot: 'is-bridge' },
  { start: 16.125, end: 24.1875, label: 'Find the red dragon', action: 'LOOK LEFT', key: 'J', hotspot: null },
  { start: 24.1875, end: 32.25, label: 'Block dragonfire', action: 'DEFEND', key: 'E', hotspot: null },
];
